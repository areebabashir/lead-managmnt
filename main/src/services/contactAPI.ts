...
class ContactAPI {
  ...
  // Import contacts (expects parsed JSON/CSV → send as array)
  ...
  // Export contacts → triggers file download (CSV or JSON)
  async exportContacts(
    ...
    a.href = url;
    a.download = format === "csv" ? "contacts.csv" : "contacts.json";
    ...
    return {
      success: true,
      message: `Contacts exported as ${format.toUpperCase()}`,
    };
  }
}
